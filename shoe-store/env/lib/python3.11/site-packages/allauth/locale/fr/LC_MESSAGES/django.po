...
"email address."
msgstr "Vous ne pouvez pas activer l'authentification à deux facteurs tant que vous n'avez pas vérifié votre adresse e-mail."

#: mfa/adapter.py:22
msgid ""
"You cannot add an email address to an account protected by two-factor "
"authentication."
msgstr "Vous ne pouvez pas ajouter une adresse e-mail à un compte protégé par l'authentification à deux facteurs."
...
msgstr "Réponse invalide lors de l'obtention du jeton de requête de \"%s\". La réponse était : %s."
...
"account."
msgstr "Impossible de confirmer %(email)s car il est déjà confirmé par un autre compte."
...
msgstr "Pour garantir la sécurité de votre compte, veuillez entrer votre mot de passe:"
...
"authenticator code:"
msgstr "Votre compte est protégé par l'authentification à deux facteurs. Veuillez entrer un code d'authentification:"
...
msgstr "L'authentification à l'aide d'une application d'authentification est active."
...
msgstr[0] "Il y a %(unused_count)s codes de récupération disponibles sur %(total_count)s."
msgstr[1] "Il y a %(unused_count)s codes de récupération disponibles sur %(total_count)s."
...
msgstr "Vous êtes sur le point de générer un nouveau jeu de codes de récupération pour votre compte."
...
msgstr "Pour protéger votre compte avec l'authentification à deux facteurs, scannez le code QR ci-dessous avec votre application d'authentification. Ensuite, saisissez le code de vérification généré par l'application ci-dessous."
...
"a later time."
msgstr "Vous pouvez stocker ce secret et l'utiliser pour réinstaller votre application d'authentification ultérieurement."
...
"sure?"
msgstr "Vous êtes sur le point de désactiver l'authentification basée sur l'application d'authentification. Êtes-vous sûr?"
...
"accounts:"
msgstr "Vous pouvez vous connecter à votre compte en utilisant l'un des comptes tiers suivants:"
