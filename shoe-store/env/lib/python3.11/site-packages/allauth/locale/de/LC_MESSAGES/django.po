...
"email address."
msgstr "Sie können die Zwei-Faktor-Authentifizierung nicht aktivieren, bis Sie Ihre E-Mail-Adresse verifiziert haben."

#: mfa/adapter.py:22
msgid ""
"You cannot add an email address to an account protected by two-factor "
"authentication."
msgstr "Sie können keine E-Mail-Adresse zu einem Konto hinzufügen, das durch die Zwei-Faktor-Authentifizierung geschützt ist."
...
msgstr "Ungültige Antwort von \"%s\" als Anfrageschlüssel erbeten wurde. Die Antwort war: %s."
...
"account."
msgstr "Kann %(email)s nicht bestätigen, da sie bereits von einem anderen Konto bestätigt wurde."
...
msgstr "Um die Sicherheit Ihres Kontos zu gewährleisten, geben Sie bitte Ihr Passwort ein:"
...
"authenticator code:"
msgstr "Ihr Konto ist durch Zwei-Faktor-Authentifizierung geschützt. Bitte geben Sie einen Authenticator-Code ein:"
...
msgstr[0] "Es steht %(unused_count)s von %(total_count)s Wiederherstellungscodes zur Verfügung."
msgstr[1] "Es stehen %(unused_count)s von %(total_count)s Wiederherstellungscodes zur Verfügung."
...
msgstr "Du bist dabei, einen neuen Satz Wiederherstellungscodes für Ihr Konto zu generieren."
...
msgstr "Um Ihr Konto mit der Zwei-Faktor-Authentifizierung zu schützen, scannen Sie den unten stehenden QR-Code mit Ihrer Authenticator-App. Geben Sie dann den von der App generierten Bestätigungscode unten ein."
...
"a later time."
msgstr "Sie können dieses Geheimnis speichern und zu einem späteren Zeitpunkt verwenden, um Ihre Authenticator-App neu zu installieren."
...
"sure?"
msgstr "Du bist dabei, die Authentifizierung per Authenticator-App zu deaktivieren. Sind Sie sicher?"
...
"accounts:"
msgstr "Sie können sich bei Ihrem Konto mit einem der folgenden Drittanbieter-Konten anmelden:"
...
msgstr "Du bist dabei, ein neues Drittanbieter-Konto von %(provider)s zu verknüpfen."
